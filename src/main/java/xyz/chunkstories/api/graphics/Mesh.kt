 ...
 * */
data class Mesh(val vertices: Int, val attributes: List<MeshAttributeSet>, val defaultMaterials: List<MeshMaterial>)
...
data class MeshMaterial(val name: String, val textures: Map<String, Texture>)