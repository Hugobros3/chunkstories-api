...
class PrefabCell(x: Int, y: Int, z: Int, data: MutableCellData) : MutableAbstractCell(x, y, z, data)

abstract class Prefab(val size: Vector3i, protected val cells: Array<PrefabCell>, protected val offset: Vector3i) {
