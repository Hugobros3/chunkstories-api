...
fun World.getCell(location: Location) = getCell(location.x.toInt(), location.y.toInt(), location.z.toInt())
fun World.getCellMut(location: Location) = getCellMut(location.x.toInt(), location.y.toInt(), location.z.toInt())
