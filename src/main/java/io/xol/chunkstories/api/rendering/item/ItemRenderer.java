...
/** Instanced once per ItemDeclaration, has the job of rendering all the Item
...
public class ItemRenderer {
	...
	/** Renders the item in the hand of the playing entity (or wherever the entity
	 * model is shown holding items)
	 * 
