...
public interface RenderTargets {
	...
	/** Creates a new configuration, depth might be = null and you are prompted to
	 * provide an arbitrary number of colour buffers */
	public RenderTargetsConfiguration newConfiguration(@Nullable RenderTarget depth, @Nullable RenderTarget... colors);

	/** Clears both types of bound rendertargets Equivalent to calling
	 * clearBoundRenderTargetZ(1.0f); and clearBoundRenderTargetColor(null); */
	...
	/** Clears the color render target (if bound) to the color specified Giving a
	 * null Vector4fm is assummed to mean Vector4fm(0, 0, 0, 0); */
	public void clearBoundRenderTargetColor(@Nullable Vector4fc color);

	/** Enables or disable the depth mask ( wether or not depth information is
	 * written ) */
