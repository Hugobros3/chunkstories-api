...
public interface RenderableAnimatableMesh extends RenderableMesh {
	...
	/** Renders the mesh geometry, skinned by a {@link SkeletonAnimator}
	 * interpolated from animationTime. */
	public void render(RenderingInterface renderer, SkeletonAnimator skeleton, double animationTime) throws RenderingException;

	/** Renders the mesh geometry, skinned by a {@link SkeletonAnimator}
	 * interpolated from animationTime, and using the materials and textures defined
	 * in the mesh file, if present */
