...
public interface RenderingIterator<E extends Entity> extends IterableIterator<E> {
	 ...
	 * 
	 * If the next element is within the view frustrum it will also prepare the
	 * renderer for this object
	 */
	public E next();

	/**
	 * Checks the current element is in view frustrum Requires you have already
	 * called next() and it returned a non-null value, otherwise it will throw a
	 * RuntimeException
	 */
