...
public enum VertexFormat {
	FLOAT(GL_FLOAT, 4), HALF_FLOAT(GL_HALF_FLOAT, 2), INTEGER(GL_INT, 4), USHORT(GL_UNSIGNED_SHORT, 2),
	NORMALIZED_USHORT(GL_UNSIGNED_SHORT, 2, true), UBYTE(GL_UNSIGNED_BYTE, 1),
	NORMALIZED_UBYTE(GL_UNSIGNED_BYTE, 1, true), U1010102(GL_UNSIGNED_INT_2_10_10_10_REV, 1, true), // <On average,
																									// based on a vec4>
	SHORT(GL_SHORT, 2), BYTE(GL_BYTE, 1),;
