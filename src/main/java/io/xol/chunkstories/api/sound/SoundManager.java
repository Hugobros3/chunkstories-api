...
public interface SoundManager
{
	 ...
	 * @param soundEffect The name of the soundEffect asset, including the file extension
	 * @param mode The Mode to use for this sound
	 * @param position The position of the sound, or NULL to play it as an ambiant sound
