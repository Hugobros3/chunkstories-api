...
public interface Chunk {
	 ...
	 *                        location for some reason
	 */
	public ChunkCell poke(int x, int y, int z, @Nullable Voxel voxel, int sunlight, int blocklight, int metadata,
	...
	/**
	 * Does the same as {@link #poke(x,y,z,d)} but without creating any VoxelContext
	 * object or triggering any updates<br/>
