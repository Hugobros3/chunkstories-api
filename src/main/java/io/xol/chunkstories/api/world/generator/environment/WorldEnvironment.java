...
public interface WorldEnvironment {
	 ...
	 * depicting vegetation, this texture is mapped to 1-1 to the world boundaries
	 */
	...
	/**
	 * Returns the shadow ('ambient') color. Be advised, this is multiplied with the
	 * voxel sunlight data, so a pitch-black cave will not pick up any of this
	 * color.
	 */
